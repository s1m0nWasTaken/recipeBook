...
void MainWindow::on_pushButton_clicked()
{
    if (ui->lineEdit->text() != "")
    {
        ...
        {
            if (ui->lineEdit->text().toUpper() == (QString::fromStdString(i->getName())).toUpper())
            {
                page->show();
                emit(sendRecipe(*i));
                return;
    ...
    for (recipe *i: recipes)
    {
        ...
        {
            if (j.getAllergies(1) && milk)
            {
                skip = true;
                continue;
            }
            if (j.getAllergies(2) && nut)
            {
                skip = true;
                continue;
            }
            if (j.getAllergies(3) && wheat)
            {
                skip = true;
                continue;
            }
            if (j.getAllergies(4) && egg)
            {
                skip = true;
                continue;
            }
...
void MainWindow::setRecipes()
{
    recipe *PorkChop = new recipe;

    PorkChop->setImage("C:\\College\\GitHub\\recipeBook\\recipeBook\\schabowy.jpeg");
    PorkChop->setImage2("C:\\College\\GitHub\\recipeBook\\recipeBook\\Projekt_bez_tytu__u_-_2022-06-07T141419.249.jpg");
    ...
    Lasagna->setImage("C:\\College\\GitHub\\recipeBook\\recipeBook\\lasagna-meat-sauce-snippet-500x500.jpg");
    Lasagna->setImage2("C:\\College\\GitHub\\recipeBook\\recipeBook\\Best-Lasagna-550-500x500.jpg");
    ...
    ingr = new vector<ingredients>;

    temp = new ingredients(1, 4/*type*/, "clove garlic");
    ingr->push_back(*temp);
    ...
    Borsch->setImage2("C:\\College\\GitHub\\recipeBook\\recipeBook\\borscht-1-FP-500x500.jpeg");
    ...
    ingr = new vector<ingredients>;
    temp = new ingredients(4.0, /*type*/4, "Medium Beets");
    ingr->push_back(*temp);
    temp = new ingredients(10.0, /*type*/4, "Vegetable Stock");
    ingr->push_back(*temp);
    temp = new ingredients(1.0, /*type*/4, "Potatoe");
    ingr->push_back(*temp);
    temp = new ingredients(1, /*type*/4, "Green Cabbage");
    ingr->push_back(*temp);
    ...
    Blini->setImage("C:\\College\\GitHub\\recipeBook\\recipeBook\\Sourdough-blinis-4-500x500.jpg");
    Blini->setImage2("C:\\College\\GitHub\\recipeBook\\recipeBook\\Russian-Crepes-Blini-20-Edit-500x500.jpg");
    ...
    temp = new ingredients(900.0, 2/*type*/, "Pork Chop");
    ingr->push_back(*temp);
